...
def calculate_mAP():
    ...
    for file in fileList:
        ...
        for item in predictedObject:
            ...
            dictPredicted[categoryIndex].append(
        ...
        for i in range(numOfClasses):
            dictPredicted[i] = sorted(
                dictPredicted[i], key=itemgetter(0), reverse=True)
        ...
        for item in groundTruthObject:
            ...
            # 0/1 denotes weather the ground truth has been alloted to a
            # prediction
