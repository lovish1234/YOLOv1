...
def preprocess_dataset():
    ...
    for line in fileHandle:
        ...
        for item in xmlObject:
            ...
            xC = ((xmin+xmax)*1.0/2.0)*(imageWidth*1.0/originalImageWidth)
            yC = ((ymin+ymax)*1.0/2.0)*(imageHeight*1.0/originalImageHeight)
            w = (xmax-xmin)*1.0
            h = (ymax-ymin)*1.0
            ...
            outputLabels = np.hstack([classProbability,boxData,responsibleGrid])
            data.append({'inputImage':imageMatrix, 'outputLabels':outputLabels})   
